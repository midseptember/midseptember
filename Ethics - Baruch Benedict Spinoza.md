...
می‌توان اینگونه فهمید که خرد یا عقل با اوصاف مختلفی ذات جوهر را ادراک می‌کند. جوهر نه همچپن چیزی بسیط و ناب بلکه با اوصاف برای عقل قابل درک است. عقل می‌تواند جوهر را ادراک کند اما تنها با صفات. صفت همان جوهر است که به شکلی خاص به ادراک درآمده است.

 ما جوهر را به ماهو جوهر یا وجود را به ماهو وجود ادراک نمی‌کنیم بلکه آن را با دو صفت امتداد و ذهن درک می‌کنیم (اگر از دکارت مایه بگیریم). برای دکارت، جسم و ذهن دو ویژگی ذاتی (properties) دارند امتداد و اندیشندگی. نزد اسپینوزا این دو نه جواهر مجزا بلکه اوصاف یک جوهر واحد اند (البته این را هنوز نمی‌دانیم؟ و در P10S) آن را به ما می‌گوید. 

Spinoza will demonstrate later in the text that extension and thinking are two of the attributes of substance. At that point it will also become clear why Descartes, along with the common-sense reader, is wrong to think of attributes as properties. Attributes are not properties of a substance and they are not separable from a substance. Attributes constitute what the substance exists as.(p. 22)

From ChatGPT: The text highlights that Spinoza disagrees with Descartes on this point. Instead of viewing extension and thinking as properties of a substance (i.e., inherent qualities), Spinoza sees them as "ways" that a substance can be perceived or expressed. In Spinoza's philosophy, these are not just properties or qualities of a substance; they are more fundamentally expressions or manifestations of the substance's essence.

###  D5

|   |   |   |
|---|---|---|
|تعریف حالت|Curley|Kisner|
|مقصود من از حالت، احوال جوهر یا شیئی است که در شیئی دیگر است و به واسطه آن به تصور می‌آید.|By mode I understand the affections of a substance, or that which is in another through which it is also conceived.|By mode I mean affections of a substance or that which is in another thing through which it is also conceived.|
|mode, in another, affection<br><br>(بجای احوال affections می‌توان از شئون و آثار هم سخن گفت)|   |   |

حالت از حیث تعریف در برابر جوهر است چرا که در دیگری است و نه در خود. وجود حالت مستلزم خودش نیست بلکه مستلزم چیز دیگری‌ست.شاید بتوان گفت که تصور مفهوم آن نیز نیازمند مفاهیم دیگر است. پس وجود و فهم آن نیازمند وجود و فهم چیزی پیش از آن است.

از تعاریف ۱ و ۳ و ۵ نتیجه می‌گیریم که جوهر آنچیزی‌ست که بر حالت‌هایش مقدم و از آنان مستقل است. نیز اینکه موجود است و نیز تصور شدنی‌ست (conceivable). 
...
|   |   |   |
|---|---|---|
|تعریف خدا|Curley|Kisner|
|مقصود من از خدا موجود مطلقا نامتناهی‌ است، یعنی جوهر، که متقوم از صفات نامتناهی است که هر یک از آن‌ها مبین ذات سرمدی و نامتناهی است.|By God I understand a being absolutely infinite, i.e., a substance consisting of an infinity of attributes, of which each one expresses an eternal and infinite essence.|By God I mean absolutely infinite being, i.e. substance consisting of infinite attributes, each one of which expresses eternal and infinite essence.|
|شرح: من می‌گویم مطلقا نامتناهی است، نه در نوع خود نامتماهی، زیرا از شیئی که فقط در نوع خود نامتناهی‌ است می‌توان صفات نامتناهی را سلب و انکار کرد، اما ذاتی که مطلقا نامتناهی‌ است در ذات خود حاوی هر چیزی است که مبین ذات است و نفی و سلب را به آن راه نیست.<br><br>I say absolutely infinite, not infinite in its own kind; for if something is only infinite in its own kind, we can deny infinite attributes of it [NS: (i.e., we can conceive infinite attributes which do not [5] pertain to its nature)]; but if something is absolutely infinite, whatever expresses essence and involves no negation pertains to its essence. (Curley)<br><br>I say absolutely infinite, and not infinite in its kind. For we can deny infinite attributes to anything that is infinite only in its kind; but if something is absolutely infinite, whatever expresses essence and involves no negation belongs to its essence.(Kisner)|   |   |
|Keywords: absolutely infinite|   |   |
مطلقا نامتناهی یعنی جوهری که بی‌نهایت صفت دارد.

### D7 
|   |   |   |
|---|---|---|
|تعریف مختار , مجبور|Curley|Kisner|
|مختار آن است که به صرف ضرورت طبیعتش موجود است و به محض اقتضای طبیعتش به افعالش موجَب. برعکس، موجب، یا به عبارت بهتر، مجبور آن است که به موجب شیئ دیگر به یک نسبت معین و محدودی در وجودش و در افعالش موجَب است.|That thing is called free which exists from the necessity of its nature alone, and is determined to act by itself alone. But a thing is [10] called necessary, or rather compelled, which is determined by another to exist and to produce an effect in a certain and determinate manner.|7. A thing is said to be free if it exists solely by the necessity of its own nature, and is  determined to action by itself alone. But a thing that is determined by another thing to exist and to operate in a specific and determinate way is necessary or rather compelled.|
|Free,  necessary|   |   |

### D8 
| تعریف سرمدیت | Curley | Kisner |
| ---- | ---- | ---- |
| مقصود من از سرمدیت نفس وجود است از این حیث که تصور شده است که بالضروره از تعریف شیئ سرمدی ناشی می‌شود. | By eternity I understand existence itself, insofar as it is conceived to follow necessarily from the definition alone of the eternal thing. | By eternity I mean existence itself insofar as it is conceived as necessarily following solely from the definition of an eternal thing. |
| شرح: زیرا این گونه وجود درست مانند ذات شیئ حقیقتی سرمدی تصور شده است و لذا ممکن نیست به وسیله دیمومت یا زمان تبیین شود، اگرچه ممکن است دیمومت بدون آغاز و انجام به تصور آید.<br><br>- For such existence, like the essence of a thing,5 is conceived as an eternal truth, and on that account cannot be explained by duration or time, even if the duration is conceived to be without beginning or end. (Curley)<br>    <br><br>- Such existence is conceived as an eternal truth just like the essence of the thing, and therefore cannot be explained through duration or time, even if duration is conceived as without beginning or end. |  |  |
| Keywords: eternity, duration, time |  |  |

سرمدیت خود وجود یا نفس وجود است و نمی‌تواند به واسطه زمان یا استمرار زمانی محدود شود.

## Axioms

### A1
| هر شیئی که موجود است یا در خودش است یا در اشیاء دیگر. | Whatever is, is either in itself or in another. | All things that are, are either in themselves or in another thing. |
| ---- | ---- | ---- |

### A2
| شیئی که ممکن نیست به واسطه شیئی دیگر تصور شود باید به نفس خویش به تصور درآید. | What cannot be conceived through another, must be conceived through itself. | Anything that cannot be conceived through another thing must be conceived through itself. |
| ---- | ---- | ---- |

  
### A3
| اگر علت متعینی وجود یابد، بالضروره از آن معلولی ناشی می‌شود، و برعکس اگر  علت متعینی موجود نباشد، انتشای معلول محال است. | From a given determinate cause the effect follows necessarily; and conversely, if there is no determinate cause, it is impossible for an effect to follow. | If there is a determinate cause, an effect necessarily follows, and conversely if there is no determinate cause, it is impossible for an effect to follow. |
| ---- | ---- | ---- |

در اینجا ظاهرا با تصور خاصی از مفهوم علیت روبروییم. تا آنجا که می‌فهمم علت متعین علتی مشخص (specific) که حضورش و وجودش حتمن به علت منتج می‌شود.علت نامتعین علتی‌ست که حضورش به نتیجه قطعی نمی‌رسد.

### A4
| شناختن معلول وابسطه شناختن  علت و مستلزم آن است. | The knowledge of an effect depends on, and involves, the knowledge of its cause. | Cognition [cognitio] of an effect depends upon cognition of its cause and involves it. |
| ---- | ---- | ---- |

شناخت اینگونه ظاهرا از شناخت علمی نشات می‌گیرد. اسپینوزا معلول را منطقاْ درون علت می‌بیند. این را احتمالا می‌توان در برابر این دیدگاه قرار داد که معلول هرچند وابسته به علت است اما می‌تواند از آن متمایز باشد و در نسبتی ترتیبی و زمانی با آن قرار داشته باشد.

### A5
| اشیائی که میانشان وجه اشتراکی موجود نیست امکان ندارد به واسطه یکدیگر شناخته شوند، یا تصور یکی مستلزم تصور دیگری نیست | Things that have nothing in common with one another also cannot be understood through one another, or the concept of the one does not involve the concept of the other. | 5. Things which have nothing in common with each other cannot be understood through each other, or the concept of the one does not involve the concept of the other. |
| ---- | ---- | ---- |

### A6
| تصور درست باید با متصوَر یا آنچه مورد تصور است مطابق باشد. | A true idea must agree with its object. | A true idea must agree with its object. |
| ---- | ---- | ---- |

### A7
| ذات شیئی که امکان دارد «لاموجود» تصور شود، مستلزم وجود نیست. | If a thing can be conceived as not existing, its essence does not involve existence. | 7. The essence of anything that can be conceived as not existing does not involve existence. |
| ---- | ---- | ---- |
...
در اینجا وی می‌خواهد استدلال کند که نمی‌توان جوهرهای متفاوت با صفات مشترک داشت.مثلا نمی‌توان دو جوهر متمایز داشت که هر دو صفت اندیشنده داشته باشند.
...
| -------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --- |
| قضیه ۱۰                                                                                                                                      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |     |
| هر یک از صفات جوهر باید به واسطه خودش تصور شود.                                                                                              | P10: Each attribute of a substance must be conceived through itself.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |     |
